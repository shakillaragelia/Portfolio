...
const socials = computed(() => {
    ...
    return [
        { label: 'GitHub',     short: 'GH',  handle: s.github    ? '@' + (s.github.split('/').pop()    ?? 'yourhandle') : '@yourhandle',   href: s.github    ?? '#' },
        { label: 'LinkedIn',   short: 'in',  handle: "Let's Connect",                                                                        href: s.linkedin  ?? '#' },
        { label: 'Instagram',  short: 'IG',  handle: s.instagram  ? '@' + (s.instagram.split('/').pop()  ?? 'yourhandle') : '@yourhandle',  href: s.instagram ?? '#' },
...
<template>
    <section id="contact" class="py-24 relative"
        ...
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
            ...
            <p class="text-[#7ab8cc] text-sm mb-12 font-mono opacity-50" data-reveal>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="glass-card p-5">
                        ...
                        <a :href="waUrl()" target="_blank"
                           class="flex items-center gap-3 bg-[rgba(0,180,216,0.06)]
                            ...
                            <span class="ml-auto text-[#00b4d8]">↗</span>
                        </a>
                ...
                <div class="glass-card p-6 flex flex-col" data-reveal>
                    ...
                    <div class="space-y-3 overflow-y-auto pr-1 flex-1"
                         style="max-height:340px; scrollbar-width:thin; scrollbar-color:rgba(0,180,216,0.25) transparent">
                        ...
                        <div v-for="c in localComments" :key="c.id"
                             class="flex gap-3 bg-[#041226] border border-[rgba(0,180,216,0.1)] rounded-xl p-3.5">
